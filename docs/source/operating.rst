[latestprojectnewfinal-00f8] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [latestprojectnewfinal-00f8] container is NOT running**.

.. tip::
   You must have your [latestprojectnewfinal-00f8] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/osayeni/newsamuelprj2/blob/main/tml-airflow/logs/logs.txt
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/osayeni/newsamuelprj2  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=39039  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='osayeni'  \-\-env DOCKERUSERNAME='osayeni'  \-\-env MQTTUSERNAME='osayeni'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   osayeni/latestprojectnewfinal-00f8-amd64 (https://hub.docker.com/r/osayeni/latestprojectnewfinal-00f8-amd64)
...
.. important::
   docker run -d -p 49797:49797 -p 49853:49853 -p 48609:48609 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=latestprojectnewfinal-00f8 \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-latestprojectnewfinal-00f8 \-\-env GITUSERNAME=osayeni  \-\-env GITREPOURL=https://github.com/osayeni/newsamuelprj2 \-\-env SOLUTIONEXTERNALPORT=49797  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=49853  \-\-env SOLUTIONVIPERVIZPORT=48609 \-\-env DOCKERUSERNAME='osayeni' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=39039 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='osayeni' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  osayeni/latestprojectnewfinal-00f8-amd64
...
.. list-table::
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - osayeni/latestprojectnewfinal-00f8-amd64
...
[latestprojectnewfinal-00f8] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/osayeni/newsamuelprj2/tree/main/tml-airflow/dags/tml-solutions/latestprojectnewfinal-00f8
...
.. important::
   https://latestprojectnewfinal-00f8.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-latestprojectnewfinal-00f8
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=49797, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=40535, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=38155, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=33329, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=38909, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=45665, HPDEHOST=127.0.1.1, HPDEPORT=35929, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=35355

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-3127-latestprojectnewfinal-00f8,solution_preprocessing_ai_mqtt_dag-latestprojectnewfinal-00f8, python-preprocess-1169-latestprojectnewfinal-00f8,solution_preprocessing_ai_mqtt_dag-latestprojectnewfinal-00f8, python-ai-1674-latestprojectnewfinal-00f8,solution_preprocessing_ai_mqtt_dag-latestprojectnewfinal-00f8, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
